...
> **Goal:** Open Thonny or https://code.org/en-US/tools/python-lab, write your first Python program, and understand what a "program" is.
...
## 2.1 Meet Thonny — Your Code Editor
...
## 2.2 Meet Python Lab — Your Online Code Editor

**Python Lab** is a web-based coding environment that lets you write and run Python code directly in your browser. No installation required.

### How to open Python Lab:
1. Open web browser (like Gooogle Chrome) and go to https://code.org/en-US/tools/python-lab
2. Create Account
3. Sign in
4. Create New Project -> Python Lab -> Console only

### Python lab has 3 important parts as Thonny
1. Menu (File,...)
2. Code editor (you type code here). Then click Run button to run your program
3. Console (results show here)
---
